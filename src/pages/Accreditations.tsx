...
const ACCREDITATIONS = [
  ...
  { id: 8, title: "Accreditation 003", image: "/Accreditations/003.jpg.jpeg", category: "Certificates" },
  { id: 9, title: "Accreditation 002", image: "/Accreditations/002.jpg.jpeg", category: "Certificates" },
  { id: 10, title: "Accreditation 001", image: "/Accreditations/001.jpg.jpeg", category: "Certificates" },
  { id: 11, title: "Research Contribution 1", image: "/Accreditations/Research-1.jpeg", category: "Research" },
  { id: 12, title: "Research Contribution 2", image: "/Accreditations/Research-2.jpeg", category: "Research" },
  { id: 13, title: "Reviewer Accreditation", image: "/Accreditations/Reviewer.jpeg", category: "Research" },
];

const CATEGORIES = ["All", ...Array.from(new Set(ACCREDITATIONS.map(a => a.category)))];
  ...
  return (
    <main>
      ...
      <section className="relative bg-brand overflow-hidden pt-36 pb-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto container-pad">
          ...
          <p className="text-white/60 text-base md:text-lg mt-6 max-w-xl leading-relaxed">
            We take pride in our recognized excellence, certifications, and national awards that validate our commitment to quality education and innovation.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto container-pad">
          ...
          {filteredItems.length === 0 && (
            <div className="py-20 text-center">
              <p className="text-muted text-lg">No accreditations found for this category.</p>
            </div>
          )}
        </div>
      </section>
      ...
      {selectedIndex !== null && (
        ...
        >
          {/* Top Bar */}
          <div className="absolute top-0 left-0 right-0 p-6 flex justify-between items-center z-50 bg-gradient-to-b from-brand/80 to-transparent pointer-events-none">
          ...
          {/* Image Container */}
          <div 
            className="max-w-6xl w-full h-full p-4 md:p-20 flex flex-col items-center justify-center pointer-events-none" 
          >
